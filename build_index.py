...
document.addEventListener("DOMContentLoaded", function() {
    const gitalk = new Gitalk({
        clientID: 'Ov23liom9xQu3sAdxf6X', // 替换为你的 GitHub Client ID
        clientSecret: '1b47474c7b40af8af53f9ae9c47c8775f92fd7a7', // 替换为你的 GitHub Client Secret
        repo: 'calculus1437.github.io', // 用于存放评论的仓库名，比如 'MathBlog'
        owner: 'calculus1437', // 你的 GitHub 用户名
        admin: ['calculus1437'], // 可以初始化评论的管理员用户名列表
        id: location.pathname.substring(location.pathname.lastIndexOf('/') + 1, location.pathname.lastIndexOf('/') + 51), // 页面唯一标识
